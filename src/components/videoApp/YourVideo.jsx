...
class YourVideo extends Component {
  ...
  componentDidMount() {
    this.props.actions.loadYourVideo(12);
  }
  render() {
    return (
      <div>
        ...
        <h1 className="center">All your video</h1>
        <ul className="list-unstyled video-list-thumbs row">
          {this.props.state.your.lists.map((video, index) => {
            return <VideoThumbnail video={video} key={index} />;
          })}
        </ul>
        {this.props.state.your.loading
          ? <div>
              <div className="loader center loader-more" />
            </div>
          : <div className="center">
              {this.props.state.your.count ===
                this.props.state.your.lists.length
                ? <div>
                    no more video
                  </div>
                : <button
                    onClick={() => {
                      this.props.actions.loadYourVideo(
                        this.props.state.your.lists.length + 12
                      );
                    }}
